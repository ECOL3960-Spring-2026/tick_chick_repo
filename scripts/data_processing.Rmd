...
temperature_data %>% write_csv(here("data","processed","temperature_data.csv"))
...
pathogen_status_data <- pathogen_status_data %>% select(siteID, plotID, plotType, nlcdClass, elevation, collectDate, individualCount, testResult, testPathogenName, subsampleID)
